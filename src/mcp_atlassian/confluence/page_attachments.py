"""Page attachment download operations for Confluence (fork-specific)."""
...
class PageAttachmentsMixin(ConfluenceClient):
    """Mixin for page attachment download operations (fork-specific)."""

    @abstractmethod
    def download_attachment(self, url: str, target_path: str) -> bool:
        """Download a single attachment. Provided by AttachmentsMixin at runtime."""
        ...
