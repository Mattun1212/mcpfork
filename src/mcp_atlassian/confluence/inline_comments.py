"""Inline comment operations for Confluence (fork-specific).

Extracted from comments.py to isolate fork-specific code from upstream.
Upstream (sooperset/mcp-atlassian) does not include inline comment support.
"""
...
from ..models.confluence import ConfluenceInlineComment
...
class InlineCommentsMixin(ConfluenceClient):
    """Mixin for Confluence inline comment operations (fork-specific)."""
