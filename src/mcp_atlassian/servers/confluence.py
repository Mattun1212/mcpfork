...
async def add_inline_comment(
    ...
    confluence_fetcher = await get_confluence_fetcher(ctx)
    try:
        inline_comment, error_message = confluence_fetcher.add_inline_comment(
            page_id=page_id,
            content=content,
        ...
        if inline_comment:
            ...
            response = {
                "success": False,
                "message": f"Unable to add inline comment to page {page_id}. {error_message or 'API request completed but inline comment creation unsuccessful.'}",
